var teamLocations = [
  {'latitude':49.24966,'longitude':-123.11934,'memberId':50,'name':'Andy Clement'},
  {'latitude':50.96055,'longitude':-1.424327,'memberId':33,'name':'Andy Wilkinson'},
  {'latitude':51.9308,'longitude':4.4792,'memberId':13,'name':'Arjen Poutsma'},
  {'latitude':40.11275,'longitude':-75.0793,'memberId':120,'name':'Artem Bilan'},
  {'latitude':45.757584,'longitude':4.832074,'memberId':124,'name':'Brian Clozel'},
  {'latitude':41.8236,'longitude':-71.4222,'memberId':101,'name':'Brian Dussault'},
  {'latitude':37.782467,'longitude':-122.4042,'memberId':90,'name':'Chloe Jackson'},
  {'latitude':50.961,'longitude':-1.425319,'memberId':30,'name':'Christopher Frost'},
  {'latitude':48.355034,'longitude':14.530615,'memberId':141,'name':'Christoph Strobl'},
  {'latitude':37.781235,'longitude':-122.5001,'memberId':131,'name':'Daniel Carwin'},
  {'latitude':52.0,'longitude':0.0,'memberId':18,'name':'Dave Syer'},
  {'latitude':40.06454,'longitude':-75.44987,'memberId':77,'name':'David Turanski'},
  {'latitude':48.85341,'longitude':2.3488,'memberId':138,'name':'Eric Bottard'},
  {'latitude':40.08644,'longitude':-75.38281,'memberId':60,'name':'Gary Russell'},
  {'latitude':50.897,'longitude':1.4042,'memberId':32,'name':'Glyn Normington'},
  {'latitude':36.52977,'longitude':-87.35945,'memberId':61,'name':'Greg Turnquist'},
  {'latitude':33.91007,'longitude':-84.31539,'memberId':75,'name':'Gunnar Hillert'},
  {'latitude':9.928451,'longitude':78.09121,'memberId':123,'name':'Ilayaperumal Gopinathan'},
  {'latitude':51.46131,'longitude':-0.303742,'memberId':110,'name':'Janne Valkealahti'},
  {'latitude':43.70011,'longitude':-79.4163,'memberId':156,'name':'Joe Grandja'},
  {'latitude':45.531563,'longitude':-122.74011,'memberId':132,'name':'John Blum'},
  {'latitude':48.3031,'longitude':14.2906,'memberId':5,'name':'Juergen Hoeller'},
  {'latitude':1.28967,'longitude':103.85007,'memberId':140,'name':'Kailashnath'},
  {'latitude':37.562992,'longitude':-122.32552,'memberId':151,'name':'Kenny Bastani'},
  {'latitude':49.28273,'longitude':-123.120735,'memberId':81,'name':'Kris De Volder'},
  {'latitude':52.22985,'longitude':21.011614,'memberId':152,'name':'Marcin Grzejszczak'},
  {'latitude':40.74019,'longitude':-73.99496,'memberId':144,'name':'Marius Bogoevici'},
  {'latitude':42.37,'longitude':-71.11,'memberId':12,'name':'Mark Fisher'},
  {'latitude':49.530113,'longitude':8.659813,'memberId':154,'name':'Mark Paluch'},
  {'latitude':40.794823,'longitude':-73.96072,'memberId':22,'name':'Mark Pollack'},
  {'latitude':53.5653,'longitude':10.0014,'memberId':68,'name':'Martin Lippert'},
  {'latitude':34.881668,'longitude':-90.00861,'memberId':136,'name':'Matt Stine'},
  {'latitude':41.776752,'longitude':-88.11954,'memberId':86,'name':'Michael Minella'},
  {'latitude':40.601185,'longitude':-112.0209,'memberId':149,'name':'Mike Heath'},
  {'latitude':51.05041,'longitude':13.73726,'memberId':69,'name':'Oliver Gierke'},
  {'latitude':-33.86,'longitude':151.2111,'memberId':80,'name':'Paul'},
  {'latitude':37.782467,'longitude':-122.4042,'memberId':87,'name':'Phil Webb'},
  {'latitude':40.717815,'longitude':-74.043144,'memberId':20,'name':'Rossen Stoyanchev'},
  {'latitude':33.52068,'longitude':-86.81176,'memberId':67,'name':'Roy Clarkson'},
  {'latitude':43.2081,'longitude':-71.5376,'memberId':158,'name':'Ryan Baxter'},
  {'latitude':37.78193,'longitude':-122.404175,'memberId':145,'name':'Sabby Anandan'},
  {'latitude':47.351994,'longitude':8.555705,'memberId':26,'name':'Sam Brannen'},
  {'latitude':32.682774,'longitude':-97.11859,'memberId':148,'name':'Scott Frederick'},
  {'latitude':45.768394,'longitude':4.872775,'memberId':143,'name':'S\xE9bastien Deleuze'},
  {'latitude':50.95738,'longitude':6.826897,'memberId':127,'name':'Sergey Shcherbakov'},
  {'latitude':48.83512,'longitude':2.382073,'memberId':161,'name':'Simon Basl\xE9'},
  {'latitude':40.77137,'longitude':-111.95111,'memberId':147,'name':'Spencer Gibb'},
  {'latitude':51.5265,'longitude':0.0825,'memberId':113,'name':'Stephane Maldini'},
  {'latitude':50.6333,'longitude':5.5667,'memberId':142,'name':'St\xE9phane Nicoll'},
  {'latitude':43.0768,'longitude':-70.7575,'memberId':41,'name':'Thomas Risberg'},
  {'latitude':49.433365,'longitude':-123.6758,'memberId':27,'name':'Trevor Marshall'},
  {'latitude':35.73608,'longitude':139.78337,'memberId':121,'name':'Tsuyoshi Miyake'},
  {'latitude':25.095,'longitude':55.16,'memberId':128,'name':'Will Schipp'}
];
var source = `
